 ...
 * Original file: /npm/perfect-freehand@1.2.2/dist/cjs/index.js
 *
 * Do NOT use SRI with dynamically generated files! More information: https://www.jsdelivr.com/using-sri-with-dynamic-files
 */
var pe = Object.defineProperty;
var ge = (e) => pe(e, "__esModule", { value: !0 });
var de = (e, t) => {
    ge(e);
    for (var s in t) pe(e, s, { get: t[s], enumerable: !0 });
};
...
function re(e, t = {}) {
    ...
    let f = [{ point: [n[0][0], n[0][1]], pressure: n[0][2] >= 0 ? n[0][2] : 0.25, vector: [1, 1], distance: 0, runningLength: 0 }],
        d = !1,
        D = 0,
        S = f[0],
        j = n.length - 1;
